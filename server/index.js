...
app.get("/", function gptServer(req, res) {
  console.log("Welcome to chat gpt server");
  return res.send("Welcome to chat gpt server");
});
app.get("/api", function gptServer(req, res) {
  console.log("chat gpt api server");
  return res.send("chat gpt api server");
});
